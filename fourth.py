...
def newmain():
    ...
    wks1.update_values('B13-E15', matrix)    
    wks1.update_values('B27-E30', matrix1)   
    wks1.update_values('B41-E43', matrix2) 
    wks1.update_values('B55-E57', matrix3)    
    wks1.update_values('B69-E71', matrix4)   
    wks1.update_values('B84-E86', matrix5) 
    wks1.update_values('B97-E99', matrix6)    
    wks1.update_values('B111-E113', matrix7)   
