...
def newmain():
    ...
    insertvalue("https://www.bybit.com/fiat/trade/otc/?actionType=0&token=USDT&fiat=RUB&paymentMethod=274",a, a1,a2,a3,a4,a5,a6,a7)
    matrix.append(a)
    matrix1.append(a1)
    matrix2.append(a2)
    matrix3.append(a3)
    ...
    insertvalue("https://www.bybit.com/fiat/trade/otc/?actionType=0&token=USDT&fiat=RUB&paymentMethod=64",b, b1,b2,b3,b4,b5,b6,b7) 
    matrix.append(a)
    matrix1.append(b1)
    matrix2.append(b2)
    matrix3.append(b3)
    ...
    insertvalue("https://www.bybit.com/fiat/trade/otc/?actionType=0&token=USDT&fiat=RUB&paymentMethod=59",c, c1,c2,c3,c4,c5,c6,c7) 
    matrix.append(c)
    matrix1.append(c1)
    matrix2.append(c2)
    matrix3.append(c3)
    ...
    wks1.update_values('G7-J9', matrix)    
    wks1.update_values('G21-J23', matrix1)   
    wks1.update_values('G35-J37', matrix2) 
    wks1.update_values('G49-J51', matrix3)    
    wks1.update_values('G63-J65', matrix4)   
    wks1.update_values('G77-J80', matrix5) 
    wks1.update_values('G91-J93', matrix6)    
    wks1.update_values('G105-J107', matrix7)   
